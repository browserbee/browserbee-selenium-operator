					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								{Name: "SE_NODE_PORT", Value: "4444"},
								{Name: "SE_LOG_LEVEL", Value: "INFO"},
								{Name: "SE_ENABLE_TRACING", Value: "true"},
								{Name: "SE_ENABLE_TLS", Value: "false"},
								{Name: "SE_HTTPS_CERTIFICATE", Value: "/opt/selenium/secrets/tls.crt"},
								{Name: "SE_HTTPS_PRIVATE_KEY", Value: "/opt/selenium/secrets/tls.key"},
								{Name: "SE_JAVA_SSL_TRUST_STORE", Value: "/opt/selenium/secrets/server.jks"},
								{Name: "SE_JAVA_SSL_TRUST_STORE_PASSWORD", Value: "/opt/selenium/secrets/server.pass"},
								{Name: "SE_NODE_MAX_SESSIONS", Value: "1"},
								{Name: "SE_NODE_BROWSER_NAME", Value: "chrome"},
								{Name: "SE_NODE_BROWSER_VERSION", Value: "stable"},
								{Name: "SE_NODE_PLATFORM_NAME", Value: "Linux"},
							},
						},
					},
				},
